"""
This file represents a interface loggin application of the Catalog from Vehicle Constructor Company.
...
#Facade Class
class LogginFacade:
    '''this class represent a facade of Vehicle Constructor Application'''
        ...
        while option != 3:
            if option == 1:
                ...
                if option==1:
                    ...
                    type="admin"
                catalog=LogginFacade(user_name, password, type, action)
                break
            elif option == 2:
                print(">>>>>>--- SIGN UP ---<<<<<<")
                action="SignUp"
