"""
this file contains the second workshop for the software design I course
...
class Engine:  
    ...
    def __init__(
        self, name_engine: str, type_engine: str, potency_engine: int, weight: float, gama:str
    ):
...
class Truck(Vehicle):  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, engine: Engine, chassis: str, model: str, year_car: int, consumption):
        self.__engine = engine
        self.__chasis = chassis
        self.__model = model
        self.__year = year_car
...
class Scooter(Vehicle):  # pylint: disable=too-few-public-methods
    """This class represents the behavior of a Scooter vehicle"""

class Helicopter(Vehicle):  # pylint: disable=too-few-public-methods
    """This class represents the behavior of a Helicopter vehicle"""
# ==================================== MENU
MESSAGE = """
Option . Create engine
Option 2. Create car
Option 3. Create truck
Option 4. Create yatch
Option 5. Create motorcyle
Option 6. Create Helicopter
Option 7. Create Scotter
...
def create_vehicle(type_vehicle: str):
    ...
    try:
        ...
        if type_vehicle == "car":
            ...
            vehicle_obj_new = Helicopter(engine, chassis, model, year_)
        elif type_vehicle == "scooter":
            vehicle_obj_new = Scooter(engine, chassis, model, year_)
